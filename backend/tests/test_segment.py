...
CASES: list[tuple[str, int, str]] = [
    ...
    # اللغات المضافة: الترقيم والاختصارات بتكسر الجمل غلط من غير قوائمها
    ("Статья 1. Поставщик обязан поставить товар.", 1, "ترقيم روسي"),
    ("Стаття 1. Постачальник зобов'язаний.", 1, "ترقيم أوكراني"),
    ("Madde 1. Tedarikçi malları teslim eder.", 1, "ترقيم تركي"),
    ("Maddə 1. Təchizatçı malları çatdırır.", 1, "ترقيم أذربيجاني"),
    ("Поставка по адресу ул. Ленина, дом 5.", 1, "بادئة عنوان روسية"),
    ("Договор заключён 15 марта 2026 г. Стороны обязуются.", 1, "г. = سنة"),
    ("Kalem, defter vb. malzemeler dahildir.", 1, "vb. + تكملة"),
    # اختصار وحدة: بيكسر بس لو اللي بعده بداية جملة
    ("Сумма составляет 150 000 руб. НДС включён.", 2, "وحدة + جملة جديدة"),
    ("Сумма составляет 150 000 руб. и налог отдельно.", 1, "وحدة + تكملة"),
    ("Pens, books etc. are included.", 1, "etc. + تكملة"),
    ("Pens, books etc. The rest follows.", 2, "etc. + جملة جديدة"),
]
