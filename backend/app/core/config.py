...
class Settings(BaseSettings):
    ...
    # الترجمة المستخدَمة للآيات، بمعرّفها على quran.com.
    # 20 = Saheeh International · 19 = Pickthall · 22 = Yusuf Ali
    # 85 = Abdel Haleem · 84 = T. Usmani
    # الاختيار ده مالوش أثر على الجودة بس: الترجمات الحديثة محمية
    # بحقوق نشر، والقديمة وضعها بيختلف من ولاية قضائية للتانية. لو
    # هتنشر المستند، اتأكد إن الترجمة اللي اخترتها مسموح بيها عندك.
    quran_translation_id: int = 20
    # sunnah.com بيديّ المفتاح بالطلب. من غيره الأداة بترجّع رابط بحث.
    sunnah_api_key: str = ""
